...
import com.example.springCloudServiceApi.api.v1.util.ApiResponseBody;
...
public class FailureResponseBody<T> extends ApiResponseBody {
    ...
    public FailureResponseBody(Integer code, Integer status, String message, T payload) {
        super(FAILURE, FAILURE, FAILURE_MESSAGE, payload);
        this.code = code;
        this.status = status;
    ...
    public FailureResponseBody(Integer code, Integer status, T payload) {
        super(FAILURE, FAILURE, FAILURE_MESSAGE, (Object) null);
        this.code = code;
        this.status = status;
        this.payload = payload;
    }
    ...
    public static <T> FailureResponseBodyBuilder<T> builder() {
        return new FailureResponseBodyBuilder();
    }
    ...
    public static class FailureResponseBodyBuilder<T> {
        ...
        public FailureResponseBodyBuilder<T> code(Integer code) {
            instance.code = code;
            return this;
        }

        public FailureResponseBodyBuilder<T> status(Integer status) {
            instance.status = status;
            return this;
        }

        public FailureResponseBodyBuilder<T> message(String message) {
            instance.message = message;
            return this;
        }

        public FailureResponseBodyBuilder<T> payload(T payload) {
